/*********************
 * UPDATE (JM): this is a copy of the default autocomplete widget with tweeks to support v3 of the tags api
 *********************/
 ...
 *
 */
this.ckan.module('autocompleteV3', function (jQuery, _) {
  return {
    ...
    getCompletions: function (string, fn) {
      ...
      var options = {
        format: function(data) {
          ...
          // JM - this only supports v2 of api.  writing new parser in line
          // TODO: all options are ignored for now
          //return {
          // results: client.parseCompletions(data, completion_options)
          //}
          var results = [];
          if( !data.success ) return {results: results};
          for( var i = 0; i < data.result.length; i++ ) {
              results.push({id:data.result[i],text:data.result[i]});
          }
